...
//FONT SIZES
define("FONT1","bold 12px roboto,sans-serif"); //list header
define("FONT2","11px roboto,sans-serif"); //list content
define("FONT3","bold 11px roboto,sans-serif"); //dates
define("FONT4","11px roboto,sans-serif"); //hover pop-up box

//SHADOWS & BOX CORNERS (0:no 1:yes)
$boxSw = 1; //box shadow
$boxRd = 4; //box corners rounded
